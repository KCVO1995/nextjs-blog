...
var _browser = require("typeorm/browser");
...
var Comment = (_dec = (0, _typeorm.Entity)(), _dec2 = (0, _typeorm.PrimaryGeneratedColumn)('increment'), _dec3 = (0, _typeorm.Column)('text'), _dec4 = (0, _typeorm.CreateDateColumn)(), _dec5 = (0, _typeorm.UpdateDateColumn)(), _dec6 = (0, _browser.ManyToOne)(function () {
  return _User.User;
}, function (user) {
  return user.comments;
}), _dec7 = (0, _browser.ManyToOne)(function () {
  return _Post.Post;
}, function (post) {
